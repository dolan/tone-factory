...
var _commit_callbacks, _discard_callbacks, _pending, _blocking_pending, _deferred, _dirty_effects2, _maybe_dirty_effects2, _Batch_instances, traverse_effect_tree_fn, defer_effects_fn, resolve_fn, commit_fn;
  ...
  while (effect2 !== null) {
    ...
    if (!skip && effect2.fn !== null) {
      if (is_branch) {
        ...
        if ((flags2 & BLOCK_EFFECT) !== 0) __privateGet(this, _dirty_effects2).add(effect2);
        update_effect(effect2);
      }
...
//# sourceMappingURL=chunk-RC62Q6FT.js.map
